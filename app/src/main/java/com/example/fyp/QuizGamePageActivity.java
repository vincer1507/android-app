...
public class QuizGamePageActivity extends AppCompatActivity {
    FButton buttonA, buttonB, buttonC, buttonD;
    TextView questionText, triviaQuizText, timeText, resultText, coinText;
    QuizHelper quizHelper;
    PlayAgainActivity.Question currentQuestion;
    List<PlayAgainActivity.Question> list;
    int qid = 0;
    int timeValue = 20;
    int coinValue = 0;
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, QuizGameStartPageActivity.class);
        startActivity(intent);
        finish();
    }
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(QuizGamePageActivity.this);
