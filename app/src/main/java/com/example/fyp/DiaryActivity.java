...
import com.example.fyp.widget.ConfirmDialog;
import com.example.fyp.widget.ImojiDialog;
import com.example.fyp.widget.LoadingDialog;
...
public class DiaryActivity extends AppCompatActivity implements OnClickListener, View.OnFocusChangeListener, TextWatcher {
	...
	private void selectRating() {
		Intent intent = new Intent(DiaryActivity.this, RatingActivtiy.class);
