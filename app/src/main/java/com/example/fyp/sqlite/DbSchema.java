package com.example.fyp.sqlite;
...
public interface DbSchema {
	...
	String COL_DIARY_DETAIL_RATING = "rating";
	...
	String CREATE_TBL_RATING = "CREATE TABLE"
								+TBL_RATING
								+"("
									+ COL_DIARY_DETAIL_RATING + "FLOAT"
									+ COL_DIARY_DATE + " DATETIME,"
	...
	String DROP_TBL_RATING = "DROP TABLE IF EXISTS "+ TBL_RATING;
}
